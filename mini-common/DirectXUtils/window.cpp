...
LRESULT CALLBACK Window::WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		MessageBoxW(nullptr, e.getMessage().c_str(), L"B³¹d", MB_OK | MB_ICONERROR);
	...
	{
		string s(e.what());
		MessageBoxW(nullptr, wstring(s.begin(), s.end()).c_str(), L"B³¹d", MB_OK | MB_ICONERROR);
	}
	...
	{
		MessageBoxW(nullptr, str, L"B³¹d", MB_OK | MB_ICONERROR);
	}
	catch (...)
	{
		MessageBoxW(nullptr, L"Nieznany B³¹d", L"B³¹d", MB_OK | MB_ICONERROR);
	}
